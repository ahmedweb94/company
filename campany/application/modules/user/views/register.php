...
<body class="hold-transition register-page">
  <div class="register-box">
    <div class="register-logo">
      <a href="<?php echo base_url(); ?>"><b>ادارة الشركات</b></a>
    </div>
    <div class="register-box-body">
      <p class="login-box-msg">تسجيل شركه جديده</p>
      ...
      <form action="<?php echo base_url().'user/registration'; ?>" method="post">
        ...
        <div class="form-group has-feedback">
         <input type="text" name="name" class="form-control" data-validation="required" placeholder="Company Name">
         <span class="glyphicon glyphicon-user form-control-feedback"></span>
       </div>
       
       <div class="form-group has-feedback">
         <input type="text" name="email" class="form-control" data-validation="required" placeholder="Company Email">
         <span class="glyphicon glyphicon-user form-control-feedback"></span>
       </div>
