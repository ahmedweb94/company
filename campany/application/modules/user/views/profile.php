  ...
  <div class="col-md-12 form f-label">
    ...
    <div class="box box-success pad-profile">
      <div class="box-header with-border">
        <h3 class="box-title">الحساب الشخصى للشركه <small></small></h3>
      </div>
      <form method="post" enctype="multipart/form-data" action="<?php echo base_url().'user/add_edit' ?>" class="form-label-left">
        <div class="box-body box-profile">
          <div class="col-md-3">
            ...
            <div class="col-md-8">
              <h3>معلومات الشركه:</h3>
              

              <div class="form-group has-feedback">
                <label for="exampleInputstatus">الحاله </label>
             ...
             <div class="form-group has-feedback clear-both">
              <label for="exampleInputname">اسم الشركه:</label>
              <input type="text" id="name" name="name" value="<?php echo (isset($user_data[0]->name)?$user_data[0]->name:'');?>" required="required" class="form-control" placeholder="Company Name">
            ...
            <div class="form-group has-feedback clear-both">
              ...
              <input type="text" id="email" name="email" value="<?php echo (isset($user_data[0]->email)?$user_data[0]->email:'');?>" required="required" class="form-control" placeholder="Company Email">
              <span class="glyphicon glyphicon-user form-control-feedback"></span>
            </div>
